				...
				<c:choose>
					<c:when test="${!empty tSubList}">
						<div class="classCardWrap">
							...
							<!--전부 보관되어있음-->
							<c:if test="${empty nCnt}"> 
								<div class="noClassWrap">
									<img src="../img/noClassImg1.svg" style="width: 300px;">
									<p>등록된 클래스가 없습니다.</p>
				...
				<c:choose>
					<c:when test="${!empty sSubList}">
						<div class="classCardWrap">
							...
							<c:if test="${empty nCnt}"> 
								<div class="noClassWrap">
									<svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" x="0" y="0" enable-background="new 0 0 683 574.4" version="1.1" viewBox="0 0 683 574.4" xml:space="preserve">
								<style>
										...
										<g transform="translate(-998 -583)">
											...
											<g>
												...
												<g>
													...
													<path d="M273.1 196.1H296.40000000000003V331.6H273.1z" class="st3" transform="translate(998 599.176) translate(154.368 180.89) matrix(5.373029e-02 -0.9986 0.9986 5.373029e-02 5.8569 533.9991)"/>
													<path d="M336.8 264.8H363.90000000000003V270.2H336.8z" class="st9" transform="translate(998 599.176) translate(154.368 180.89) matrix(5.373029e-02 -0.9986 0.9986 5.373029e-02 64.4918 602.9711)"/>
													<path d="M330.9 264.4H358V269.79999999999995H330.9z" class="st9" transform="translate(998 599.176) translate(154.368 180.89) matrix(5.373029e-02 -0.9986 0.9986 5.373029e-02 59.1939 596.7164)"/>
			...
			<div class="modalCon">
				...
				<form action="../subject/subject.do" method="post">
					<c:forEach items="${tList}" var="teacherVo">
						...
						<input type="hidden" name="tname" value="${teacherVo.tname}">
					</c:forEach>
